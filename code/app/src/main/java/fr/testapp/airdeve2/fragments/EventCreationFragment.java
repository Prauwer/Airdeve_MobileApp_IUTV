...
public class EventCreationFragment extends Fragment {
    ...
    public EventCreationFragment(MainActivity context, UserModel mainUser) { this.mainContext = context; this.mainUser=mainUser;}
                    ...
                    builder.setTitle("Ces données sont-elles bien correctes ?")
                            ...
                            .setPositiveButton("OUI", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    event = new EventModel(nameText.getText().toString().trim(),
                                    descriptionText.getText().toString().trim(),
                                    imgUrlText.getText().toString().trim(),
                                    Integer.valueOf(capacityText.getText().toString().trim()),
                                    Calendar.getInstance().getTime(),
                                    dateE,
                                    Arrays.asList(mainUser),
                                    Integer.valueOf(moneyNeededText.getText().toString().trim()),
                                    placeText.getText().toString().trim(),
                                    ...
                                    mainContext.getRepo().getEventList().add(event);

                                    mainContext.loadFragment(new HomeFragment(mainContext));
                                }
                            })
