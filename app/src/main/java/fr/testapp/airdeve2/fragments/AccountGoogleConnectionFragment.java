...
public class AccountGoogleConnectionFragment extends Fragment
{
    ...
    public AccountGoogleConnectionFragment(MainActivity context)
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_account_google_connection, container, false);
